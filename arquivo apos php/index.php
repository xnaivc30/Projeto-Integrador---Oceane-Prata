...
<body class="Pagina1">
    <div class="topo">
        <header><img src="imagens/Design sem nome.png" alt="Logotipo da loja Pratas Oceano com letras elegantes sobre fundo branco" width="800px">
            <h2>OCEANE PRATA</h2>
        </header>
        <nav>
            <a href="/carrinho" class="botao-carrinho">
                <a href="#">HOME</a>
    ...
    <main>
        ...
        <div class="SegundaParte">
            <div class="cimapt1">
                ...
                <div class="cards" data-categoria="SEMIJOIAS"><img src="imagens/colar de prata 4.webp" alt="Colar clássico" height="220px" width="150px">
            ...
            <div class="baixopt2">
                <div class="cards" data-categoria="ALIANÇAS"><img src="imagens/Imagem aliança 1.webp" alt="Brincos elegantes" height="220px" width="150px">
                    <h2>Aneis Elegantes</h2>
                    <p>Peças delicadas com brilho <br> forte.</p>
                    <span>R$ 189,90 <strong class="antigo">R$ 239,90</strong></span>
                    <button onclick="alterarBotao(this)">Adicionar</button>
                </div>
                <div class="cards" data-categoria="BRINCOS"><img src="imagens/pulseira 3.webp" alt="Acessórios luxo" width="150px">
                    ...
                    <p>Acabamento para ocasiões <br> especiais.</p>
                    <span>R$ 189,90 <strong class="antigo">R$ 239,90</strong></span>
                    <button onclick="alterarBotao(this)">Adicionar</button>
                </div>
