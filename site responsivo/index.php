...
<?php include("header.php"); ?>
        ...
        <div class="PrimeiraParte">
            <div class="Esquerda">
                <div>
                    ...
                    <p>Autenticidade e estilo para todos os momentos. Peças únicas em prata 925 e semijoias selecionadas
                        para brilhar no seu dia a dia.</p>
        ...
        <div class="SegundaParte">
            <div class="cimapt1">
                <div class="cards" data-categoria="CORRENTES"><img src="imagens/colar de prata 2.webp"
                    ...
                    <span>R$ 219,90 <strong class="antigo">R$ 269,90</strong></span>
                ...
                <div class="cards" data-categoria="CORRENTES"><img src="imagens/colar de prata 3.webp"
                    ...
                    <span>R$ 229,90 <strong class="antigo">R$ 279,90</strong></span>
                    <form action="adicionar_carrinho.php" method="POST">
                ...
                <div class="cards" data-categoria="SEMIJOIAS"><img src="imagens/colar de prata 4.webp"
                    ...
                    <p>Peça leve e elegante para qualquer <br> look.</p>
                    <span>R$ 199,90 <strong class="antigo">R$ 249,90</strong></span>
                    <form action="adicionar_carrinho.php" method="POST">
            ...
            <div class="baixopt2">
                <div class="cards" data-categoria="ALIANÇAS"><img src="imagens/Imagem aliança 1.webp"
                    ...
                    <span>R$ 239,90 <strong class="antigo">R$ 289,90</strong></span>
                <form action="adicionar_carrinho.php" method="POST">
    ...
    <button type="submit">Adicionar</button>
                ...
                <div class="cards" data-categoria="BRINCOS"><img src="imagens/pulseira 3.webp" alt="Acessórios luxo"
                    ...
                    <span>R$ 179,90 <strong class="antigo">R$ 229,90</strong></span>
                    <form action="adicionar_carrinho.php" method="POST">
                ...
                <div class="cards" data-categoria="SEMIJOIAS"><img src="imagens/colar de prata 3.webp" alt="Semijoias"
                        width="150px">
                    <h2>Semijoias</h2>
                    <p>Estilo versátil que combina com <br> tudo.</p>
                    <span>R$ 209,90 <strong class="antigo">R$ 259,90</strong></span>
                    <form action="adicionar_carrinho.php" method="POST">
        ...
        <div id="Contato" class="PaginaContato">
            <div class="banner1">
                <h2>FALE <span style="color: gold;">CONOSCO</span> </h3>
                    <h2><span style="color: #4ecdc4;">Estamos aqui para ajudar!</span></h2>
            </div><br><br>

            <div class="envolvetudo">
                <div class="direita3">
                    <p>Tem dúvidas ou precisa de ajuda? Nossa equipe está pronta para atender você. Envie uma mensagem e
                        responderemos o mais breve possível.</p>
                    <h3>Envie uma mensagem para o nosso <span style="color: rgb(50, 173, 50);">WhatsApp</span></h3>
                    <form action="">
                        ...
                        <button onclick="AjudaEnviarMensagem()">Enviar Mensagem</button> <br>
